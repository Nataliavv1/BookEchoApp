...
export default function BookOptions({bookTitle, book}) {
  ...
  console.log("Objecte book rebut:", book);
  return (
    <View>
      ...
      <AddBookToList visible={saveVisible} onCancel={handleSaveClose} bookTitle={bookTitle} book={book}></AddBookToList>
